...
<h1 className="absolute top-50 left-110 italic text-white text-8xl font-[Nunito Sans] font-bold tracking-wide " >Smart Picks, Just for You</h1>
<p className="absolute top-65 left-60 text-center italic text-white text-3xl font-[Nunito Sans] font-light tracking-normal">Discover content that speaks to you — articles, courses, and videos curated to your taste.</p>
<button onClick={() => navigate('/signup')}
  className="absolute top-[22rem] left-[40rem] w-[200px] h-[85px] rounded-[2rem] border-[5px] border-white text-white text-[48px] font-nunito font-light"
>
  <span className=" text-white text-[40px] font-nunito font-light" >SignUp</span>

</button>
<span className="absolute top-[28rem] left-[45rem] text-[#B0AAAA] text-3xl font-[Nunito Sans] font-light ">or</span>
<button onClick={() => navigate('/login')}
  className="absolute top-[32rem] left-[40rem] w-[200px] h-[85px] rounded-[2rem] border-[5px] border-white  text-white text-[48px] font-nunito font-light"
>
  <span className=" text-white text-[40px] font-nunito font-light">Login</span>
