...
<h1 className="absolute top-[2rem] left-[40rem] text-white text-[48px] font-[Nunito Sans] font-bold tracking-wide">SIGNUP</h1>
<p className="absolute top-[5rem] left-[27rem] italic text-white text-[32px] font-[Nunito Sans] font-light tracking-normal">Join us and get content that actually matters to you</p>
<form className="absolute top-[10rem] left-[27rem] flex flex-col gap-5" onSubmit={handleSubmit}>
  <input className="w-[40rem] h-[4rem] rounded-4xl border-white border-3 text-white text-[24px] font-[Nunito Sans] font-normal px-5 "  type="text" name="username" placeholder='Enter your Username' onChange={handleFormData}></input>
    <input className="w-[40rem] h-[4rem] rounded-4xl border-white border-3 text-white text-[24px] font-[Nunito Sans] font-normal px-5" type="email" name="email" placeholder='Enter your Email' onChange={handleFormData}></input>
  <input className="w-[40rem] h-[4rem] rounded-4xl border-white border-3 text-white text-[24px] font-[Nunito Sans] font-normal px-5" type="password" name="password" placeholder="Enter your password" onChange={handleFormData}></input>
    <input className="w-[40rem] h-[4rem] rounded-4xl border-white border-3 text-white text-[24px] font-[Nunito Sans] font-normal px-5" type="password" name="confirmPassword" placeholder="Confirm your password" onChange={handleFormData} ></input>
  <button 
  className="absolute left-[15rem] top-[21rem] w-[10rem] h-[3rem] text-white text-[48px] font-['Nunito Sans'] font-bold"
